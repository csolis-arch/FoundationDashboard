...
function renderOverview(year) {
  ...
  const insights = d.insights || [
    ...
    {title:"Capital Campaign Concentration",body:`Major capital investments: Witte Museum ($1.5M), Madonna Center ($350K), Haven for Hope Phase II ($250K), Lifetime Recovery ($250K), and Children's Hospital epilepsy program ($250K). These commitments represent strategic multi-year bets rather than operational grants.`},
