...
DATA[2026].insights = [
  ...
  { title:'Haven for Hope as Strategic Platform',
    body:'Beyond $2M in direct support (operations + capital), the Foundation funds multiple organizations delivering services on the Haven campus — Dr. Usatine\'s dermatology clinic ($125K), SA Christian Dental ($220K), Thrive Youth Center, and the multi-org back-to-school drive — pushing total Haven-ecosystem investment above $2.3M.' },
  ...
  { title:'A Broad Small-Grant Base',
    body:'Setting the headline gifts aside, the cycle funds a wide range of $5K–$75K grants across children\'s services, basic needs, disability and health — Kinetic Kids, Guide Dogs, Sleep in Heavenly Peace, Texas Ramp Project, Threads of Love and dozens more — reflecting continued breadth alongside the large bets.' },
  { title:'Health & Human Welfare — Targeted Bets',
